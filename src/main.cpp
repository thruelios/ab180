...
unsigned int nTargetSpacing = 1 * 20; // 20 secs
...
int nCoinbaseMaturity = 10; // 20 blocks mature
...
const string strMessageMagic = "synapse Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 10) // Stock Coins for pre-sale
    {
...
// synapse: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "synapse", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "The Ultra Fast Coin Synapse";
        CTransaction txNew;
        txNew.nTime = 1447591761;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xdb90cb1bdcb954059cbc50911e59477e2c49b3025660c2a96a3d363d58d36ee1"));
        block.print();
